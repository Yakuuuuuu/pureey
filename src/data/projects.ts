...
export const allProjects: Project[] = [
  {title: 'Heat Exchanger Design', desc: 'Compact heat exchanger for HVAC application with optimized thermal performance', tools: ['AutoCAD', 'ANSYS'], id: 1, category: 'Thermal Systems', image: "/src/assets/project1.jpg"},
  {title: 'Gearbox Prototype', desc: 'High-efficiency gearbox for small machinery with reduced noise and vibration', tools: ['SolidWorks', 'Fusion 360'], id: 2, category: 'Mechanical Design', image: "/src/assets/project2.jpg"},
